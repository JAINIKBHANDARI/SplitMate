...
export default function JoinGroup() {
  ...
  useEffect(() => {
    if (inviteCode && !join.isPending && !join.isSuccess && !join.isError)
      join.mutate();
  }, [inviteCode]);
  ...
  return (
    <div className="mx-auto grid min-h-[55vh] max-w-md place-items-center">
      <Card className="w-full p-8 text-center">
        ...
        <h1 className="mt-4 text-xl font-extrabold">Joining your group</h1>
        {join.isError ? (
          <>
            <p className="mt-2 text-sm text-rose-600">
              That invite is unavailable or has expired.
            </p>
          ...
          <p className="mt-2 text-sm text-slate-500">
            One moment. We’re adding you in.
          </p>
        )}
      </Card>
    </div>
